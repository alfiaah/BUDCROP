...
<body class="main-layout ">
                            ...
                            <form class="main_form" method="POST">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <input class="form-control" placeholder="Category Name" type="text" name="category_type" required>
                                    </div>
	...
	if(isset($_POST['submit']))
	{
		...
		$ins="insert into category(category_type,nid) values ('$category_type','$a')";
