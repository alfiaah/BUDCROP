...
$lenstype=$_POST['lenstype'];  //lenstype lenspower framelength
$lenspowerl=$_POST['lenspowerl'];
$lenspowerr=$_POST['lenspowerr'];
$framelength=$_POST['framelength'];
$pdd=$_SESSION['pid'];
...
mysqli_query($con,"insert into orders(userId,productId,quantity,lenstype,lenspower,framelength) values('".$_SESSION['id']."','$qty','$val34','$lenstype','$lenspower','$framelength')");
...
<th class="cart-product-name item">lens powerl</th>
<th class="cart-product-name item">lens powerr</th>
<th class="cart-product-name item">lens type</th>
<th class="cart-product-name item">frame length</th>
...
<div class="row">
<!-div class="col-sm-4">
<div class="rating rateit-small"></div><!-----star symball---->
</div>
<div class="col-sm-8">
...
<div class="quant-input">
               ...
               <div>
                <input type="text" value="" name="lenspowerl" placeholder="left" required></div>
             
           <!-- <input type="text" value="<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>" name="lenspower"  required>-->
...
<div class="quant-input">
              ...
              <!-- <div>
                <input type="text" value="" name="lenspowerl" placeholder="left" required></div>-->
              <div> <input type="text" value="" name="lenspowerr" placeholder="right" required>
               </div>
           <!-- <input type="text" value="<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>" name="lenspower"  required>-->
...
<!--<input type="text" value=" "  name="lenstype"  required>-->
lenstype:
<select>
<option value="select">select</option>
<option value="Pain glass">plain-Glass</option>
<option value="Anti-Glaire">Anti-Glaire</option>
...
<td class="">
<div class="">
           <!--   <input type="text" value=" " name="framelength"  required>-->
           FrameLength:
<select>
<option value="select">select</option>
