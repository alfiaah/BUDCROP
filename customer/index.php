                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 pa_left">
                                        <div class="cross_inner">
                                            <h3>Krishna Kumar<br><strong class="ornage_color">Haappy Customer</strong></h3>
                                            <p><img src="icon/1.png" alt="#" />Most of the plants I have shopped from BUD CROP came in good condition and if ever I had complaint about any problem, their team replaced the plants for me. I am happy with the service and look forward to buy more plants from here. The variety they have to offer is mind blowing, I have learnt and known about most uncommon or unseen plants from their website:) Thank you Team -BUD CROP.
                        ...
                        <div class="testomonial_section">
                            ...
                            <div class="full testimonial_cont text_align_center cross_layout">
                                <div class="row">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 pa_left">
                                        <div class="cross_inner">
                                            <h3>Mridula<br><strong class="ornage_color">Customer</strong></h3>
                                            <p><img src="icon/1.png" alt="#" />I order a strawberry plant and received in 5 days. The packing was good and the plant is very healthy. I hope plant grows well. These people has best online service . Thank you
                                                <img src="icon/2.png" alt="#" />
                                            </p>
                        ...
                        <div class="testomonial_section">
                            ...
                            <div class="full testimonial_cont text_align_center cross_layout">
                                <div class="row">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 pa_left">
                                        <div class="cross_inner">
                                            <h3>Rohan<br><strong class="ornage_color">customer</strong></h3>
                                            <p><img src="icon/1.png" alt="#" />The begonia plant which I got was beautiful and in excellent condition...there was a lot of foliage and the pot was also of very good quality...this was my best purchase of plants online...very happy with plantsguru and have placed order for three more plants <img src="icon/2.png" alt="#" />
                                           </p>
